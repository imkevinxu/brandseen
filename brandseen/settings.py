# Django settings for brandseen project.
...
DATABASES = {
    'default': {
        ...
        'NAME':  'brandseen',                      # Or path to database file if using sqlite3.
        'USER': 'brandseen_user',                      # Not used with sqlite3.
        'PASSWORD': 'OA!zKCRWikaKKCSG4DuiHA%FEr9MF1',                  # Not used with sqlite3.
...
SECRET_KEY = 'AvL,Td2!p4NGsl%SwouY<vi:z8n}[gZXm:2+8eA([RsE-_"TJ-'
...
ROOT_URLCONF = 'brandseen.urls'

WSGI_APPLICATION = 'brandseen.wsgi.application'
